...
<div id="post-container">
    ...
    $aria_req = ( $req ? " aria-required='true'" : '' );
        ...
        $args = array(
            ...
            'fields' => $fields,
            'comment_field' =>  '<textarea placeholder="Your Commnent" id="comment" name="comment" cols="45" rows="8" aria-required="true">' . '</textarea>',
            'comment_notes_before' => '<p class="comment-notes">Your email address will not be published. All fileds are required.</p>'
        );
